...
:::tip Совет
При изменении announce по умолчанию, будет изменён доступ ко всем новым командам, а также существующим командам, кроме тех, которым указывали announce отдельно
:::
